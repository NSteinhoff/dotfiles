...
CompilerSet makeprg=clang\ -Werror\ -Wall\ -Wextra\ -pedantic\ -Wno-declaration-after-statement\ -Wno-strict-prototypes\ -Wno-shadow\ -Wno-padded\ -Wno-implicit-fallthrough\ -fsyntax-only\ %\ $*
